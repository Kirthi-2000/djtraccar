...
def connect(host="localhost", user="root", password="Kiruthi@12",
            db="pytraccar", port=3306, unix_socket=None,
...
class Connection:
    ...
    def __init__(self, host="localhost", user="root", password="Kiruthi@12",
